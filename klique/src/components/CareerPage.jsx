...
function CareerPage({ onContactClick }) {
  ...
  const handleFilterSearch = () => {
    ...
    if (searchType !== 'All types') {
      filtered = filtered.filter(job => job.type === searchType);
    }
    ...
    setJobs(filtered);
    setSelectedCategory('All'); // Reset chip selection on manual search
  };
  ...
  const handleChipClick = (category) => {
    ...
    if (category === 'All') {
      ...
      const filtered = JOBS_DATA.filter(job => job.category === category);
      setJobs(filtered);
    }

    // Reset search card fields
    setSearchLocation('');
  ...
  return (
    <div className="career-page w-full">
      ...
      <section className="career-hero">
        ...
        <div className="career-hero-content career-reveal">
          ...
          <h1 className="career-hero-title">
            Build the future of <span className="career-accent">smarter software</span> with us
          </h1>
          <p className="career-hero-sub">
            From Salesforce to custom web and app development — at Klique you build real products that scale businesses. Let's build something great together.
          </p>
      ...
      <div className="career-filters career-reveal">
        {['All', 'Engineering', 'Salesforce', 'Design', 'Internship'].map((cat) => (
          <div 
            key={cat}
      ...
      <section className="career-section career-section-perks">
        <div className="career-section-head career-reveal">
          ...
          <p>We are a small team that works for big impact. Every person's work matters here.</p>
        </div>
        
        <div className="career-perks-grid">
          <div className="career-perk-card career-reveal" style={{ transitionDelay: '0.05s' }}>
            ...
            <p>From day 1 you will work on actual client projects, not just training tasks.</p>
          </div>
          
          <div className="career-perk-card career-reveal" style={{ transitionDelay: '0.15s' }}>
            <div className="career-perk-icon">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline><polyline points="16 7 22 7 22 13"></polyline></svg>
            </div>
            <h3>Fast growth</h3>
            <p>Full support for Salesforce certifications, mentorship, and skill-building.</p>
          </div>
          
          <div className="career-perk-card career-reveal" style={{ transitionDelay: '0.25s' }}>
            <div className="career-perk-icon">
            ...
            <h3>Flexible work</h3>
            <p>Both remote and hybrid options, we focus on results, not hours.</p>
          </div>
          
          <div className="career-perk-card career-reveal" style={{ transitionDelay: '0.35s' }}>
            <div className="career-perk-icon">
            ...
            <h3>Open culture</h3>
            <p>Flat hierarchy, direct communication, and a team that listens to ideas.</p>
          </div>
        </div>
      </section>
          ...
          <div className="career-jobs-list">
            {jobs.length > 0 ? (
              jobs.map((job, idx) => (
                ...
                >
                  <div className="career-job-left">
                    <div className="career-job-badge">{job.badge}</div>
                    <div>
                      <div className="career-job-title">{job.title}</div>
                      <div className="career-job-meta">
                        <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> {job.location}</span>
                        <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg> {job.type}</span>
                        <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg> {job.exp}</span>
                        <span className="career-job-tag">{job.category}</span>
                      </div>
                    </div>
                  </div>
                  <button 
              ...
              <div className="career-empty-state career-reveal">
                ...
                <p>We currently have no listings for this filter. Please adjust your search terms.</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section className="career-cta-section career-reveal">
        ...
        <p>Send us your resume — we will contact you whenever a matching opening comes up.</p>
      ...
      {activeJob && (
        <div className="career-modal-overlay">
          <div className="career-modal">
            ...
            <p className="career-modal-subtitle">{activeJob.category} &middot; {activeJob.location}</p>
              ...
              <form onSubmit={handleApplySubmit} className="career-modal-form">
                ...
                <div className="blog-floating-group">
                  <input
                    ...
                    className="blog-floating-input"
                  />
                  <label className="blog-floating-label">Link to Resume / Portfolio*</label>
                </div>
                ...
                <div className="blog-floating-group">
                  ...
                  />
                  <label className="blog-floating-label">Why should we hire you?</label>
                </div>
